const { JsonFeedEventSource } = require("fullcalendar");
...
! function (e, t) {
        ...
        var r = function () {
            ...
            o = function (e) {
                ...
                return function (e, t) {
                    ...
                    key: "initClass",
                    value: function () {
                        this.prototype.Emitter = r, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "downloadfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                            url: null,
                            method: "post",
                            withCredentials: !1,
                            timeout: 3e4,
                            ...
                            dictDownloadFileConfirmation: null,
                            ...
                            addedfile: function (e) {
                                ...
                                if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                                    ...
                                    this.options.addRemoveLinks && (e._removeLink = o.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictDownloadFile + "</a>"), e.previewElement.appendChild(e._removeLink));
                                    ...
                                    //add download!!!
                                    this.options.addDownloadLinks && (e._openLink = o.createElement('<a class="dz-download" href="https://www.google.com" target="_blank" data-dz-download>' + this.options.dictDownloadFile + "</a>"), e.previewElement.appendChild(e._openLink));
                                    for (var l = function (i) {
                                        return i.preventDefault(), i.stopPropagation(), e.status === o.UPLOADING ? o.confirm(t.options.dictCancelUploadConfirmation, function () {
                                            return t.downloadFile(e)
                                        }) : t.options.dictRemoveFileConfirmation ? o.confirm(t.options.dictRemoveFileConfirmation, function () {
                                            return t.downloadFile(e)
                                        }) : t.downloadFile(e)
                                    }, u = 0, d = d = e.previewElement.querySelectorAll("[data-dz-download]"); ;) {
                                        if (u >= d.length) break;
                                        d[u++].addEventListener("click", l)
                                    }
                ...
                },
                {
                    key: "downloadFile",
                    value: function (e) {
                        if (e.status === o.UPLOADING && this.cancelUpload(e), this.files = s(this.files, e), this.emit("downloadfile", e), 0 === this.files.length) return null
                    }
                }, {
                    key: "removeAllFiles",
                    value: function (e) {
    ...
    return function (e, t, i, n, r, o, s, a, l, u) {
        ...
        mounted() {
            ...
            }), this.dropzone.on("downloadfile", function (t) {
                e.$emit("vdropzone-download-file", t), t.manuallyAdded && null !== e.dropzone.options.maxFiles && e.dropzone.options.maxFiles++
